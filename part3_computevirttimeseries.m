...
for i=4:14%length(subjects)
    ...
    procuedata.combined = [procuedata.correctness,procuedata.dir];
    prosaccdata.combined = [prosaccdata.correctness,prosaccdata.dir];
    
    anticuedata.combined = [anticuedata.correctness,anticuedata.dir];
    antisaccdata.combined = [antisaccdata.correctness,antisaccdata.dir];
    
    %% start with procuedata
